...
set_labels = {'A': ['T005', 'T007', 'T037', 'T038', 'T058', 'T074', 'T092', 'T098', 'T168', 'T170'],
              'B': ['T017', 'T031', 'T062', 'T082', 'T091', 'T097', 'T103', 'T201', 'T204'],
              'full': ['T005', 'T007', 'T037', 'T038', 'T058', 'T074', 'T092', 'T098', 'T168', 'T170', 'T017', 'T031', 'T062', 'T082', 'T091', 'T097', 'T103', 'T201', 'T204']}
...
for i in range(epochs):
    ...
    for j in range(l):
        loss_A = train(batches_A[j])
        loss_B = train(batches_B[j])

        if j % 100 == 0:
            f1, _ = run_evaluation(
                dev_batches, 'dev (iteration %d)' % i)
...
run_evaluation(train_batches_A, 'A_train')
run_evaluation(train_batches_B, 'B_train')

run_evaluation(dev_batches, 'dev')
run_evaluation(test_batches, 'test')
