...
dp.read_file(cdr_path + 'ner_CID_Training_mine_PubTator.txt', 'cdr_train', 'cdr', update=True)
...
def train(batch, A=True):
    ...
    lstm_feed = {
        ...
        model.max_seq_len: batch_seq_len,
        model.batch_size: batch_size,
        model.hidden_dropout_keep_prob: hidden_dropout,
        model.middle_dropout_keep_prob: middle_dropout,
        model.input_dropout_keep_prob: input_dropout,
        model.l2_penalty: l2,
        ...
        if j % 1000 == 0:
            ...
            if f1 > max_f1:
                save_path = saver.save(
                    sess, model_path + 'model_best_parameters.ckpt')
